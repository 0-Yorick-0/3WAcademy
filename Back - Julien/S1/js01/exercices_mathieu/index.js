...
[
    ...
    longueurPhrase: function(){
        for (var i = 0; i < this.phrases.length; i++){
            if (this.longueur < this.phrases[i].length) {
                this.longueur = this.phrases[i].length;
    ...
    afficherResultat: function(){
        var text = "La phrase la plus longue est : " + this.phrase + " et sa longueur est : " + this.longueur;
        this.insertionElement(text);
    },
};

phraseLaPlusLongue.run();